      ...
      <div class="panel panel-default">
        <div class="panel-heading clearfix">
          <h1 class="col-xs-12 col-sm-8 col-md-7 col-lg-6">
            <a href="{{ route('messages') }}" title="@lang('section.messages')" class="pull-left visible-sm-block">
              <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
            </a>
            @lang('messages.new_messages')</h1>
        </div>
          ...
          <form
            ...
            <div class="form-group{{ $errors->has('type_of_operation') ? ' has-error' : ''}}">
              <label
                ...
                class="col-xs-12 col-sm-3 col-md-3 col-lg-2 control-label">@lang('message.type_of_operation'): </label>
            ...
            <div class="form-group{{ $errors->has('internal_expedient_id') ? ' has-error' : ''}}">
              <label
                for="expedient_id"
                class="col-xs-12 col-sm-3 col-md-3 col-lg-2 control-label">@lang('message.internal_expedient'): </label>
              <div class="col-xs-12 col-sm-3 col-md-4 col-lg-2">
                <select
                  class="form-control"
            ...
            <div class="form-group{{ $errors->has('address') ? ' has-error' : ''}}">
              <label
                for="address"
                class="col-xs-12 col-sm-3 col-md-3 col-lg-2 control-label">@lang('message.property_address'): </label>
              <div class="col-xs-12 col-sm-9 col-md-9 col-lg-10 control-label">
                <input
                  ...
                  name="address"
                  value="{{ old('address') }}"
                  placeholder="@lang('message.property_address')"
                  autocorrect="on">
            ...
            <div class="form-group{{ $errors->has('state_id') ? ' has-error' : ''}}">
              <label
                for="state_id"
                class="col-xs-12 col-sm-3 col-md-3 col-lg-2 control-label">@lang('message.state_of_the_republic'): </label>
              <div class="col-xs-12 col-sm-3 col-md-4 col-lg-2 control-label">
                <select
                  ...
                  <option
                    ...
                    @if (old('state_id'))
                      selected
                    @endif>@lang('message.choose_a_state')</option>
            ...
            <div class="form-group{{ $errors->has('status') ? ' has-error' : ''}}">
              <label
                for="status"
                class="col-xs-12 col-sm-3 col-md-3 col-lg-2 control-label">@lang('message.status'): </label>
              <div class="col-xs-12 col-sm-9 col-md-9 col-lg-10 control-label">
                <input
                  type="text"
                  class="form-control"
                  name="status"
                  value="{{ old('status') }}"
                  placeholder="@lang('message.status')"
                  autocorrect="on">
            ...
            <div class="form-group{{ $errors->has('priority') ? ' has-error' : ''}}">
              <label
                for="priority"
                class="col-xs-12 col-sm-3 col-md-3 col-lg-2 control-label">@lang('message.priority'): </label>
              <div class="col-xs-12 col-sm-3 col-md-4 col-lg-2 control-label">
                <select
                  class="form-control"
                  name="priority"
            ...
            <div class="modal-dialog modal-lg" role="document">
              <form
                ...
                <div class="modal-header">
                  ...
                  <h4 class="modal-title">@lang('message.new_expedient')</h4>
                </div>
                <div class="modal-body">
                  <div class="form-group{{ $errors->has('expedient') ? ' has-error' : ''}}">
                    ...
                    <div class="col-xs-12 col-sm-9 col-md-9 col-lg-10 control-label">
                      <input
                        ...
                        name="expedient"
                        value="{{ old('expedient') }}"
                        placeholder="@lang('message.internal_expedient')"
                        autocorrect="on">
                  ...
                  <div class="form-group{{ $errors->has('expedient_id') ? ' has-error' : ''}}">
                    <label
                      for="client_id"
                      class="col-xs-12 col-sm-3 col-md-3 col-lg-2 control-label">@lang('message.client'): </label>
          ...
          <div
            ...
            <div class="modal-dialog modal-lg" role="document">
              <form
                ...
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                  <h4 class="modal-title">@lang('message.new_client')</h4>
                </div>
                <div class="modal-body">
                  <div class="form-group{{ $errors->has('first_name') ? ' has-error' : ''}}">
                    <label
                    for="first_name"
                    class="col-xs-12 col-sm-4 col-md-4 col-lg-3 control-label">@lang('message.clients_first_name'): </label>
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-9">
                      ...
                      placeholder="@lang('message.clients_first_name')"
                      autocorrect="on"
                      required>
                  ...
                  <div class="form-group{{ $errors->has('last_name') ? ' has-error' : ''}}">
                    <label
                    for="last_name"
                    class="col-xs-12 col-sm-4 col-md-4 col-lg-3 control-label">@lang('message.clients_last_name'): </label>
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-9">
                      <input
                      type="text"
                      class="form-control"
                      ...
                      id="last_name"
                      value="{{ old('last_name') }}"
                      placeholder="@lang('message.clients_last_name')"
                      autocorrect="on"
                      required>
                  ...
                  <div class="form-group{{ $errors->has('phone_1') ? ' has-error' : ''}}">
                    <label
                    for="phone_1"
                    class="col-xs-12 col-sm-4 col-md-4 col-lg-3 control-label">@lang('message.phone') 1: </label>
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-9">
                      <input
                      type="tel"
                      class="form-control"
                      ...
                      id="phone_1"
                      value="{{ old('phone_1') }}"
                      placeholder="@lang('message.phone') 1"
                      autocorrect="on"
                      required>
                  ...
                  <div class="form-group{{ $errors->has('phone_2') ? ' has-error' : ''}}">
                    <label
                    for="phone_2"
                    class="col-xs-12 col-sm-4 col-md-4 col-lg-3 control-label">@lang('message.phone') 2: </label>
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-9">
                      <input
                      type="tel"
                      class="form-control"
                      ...
                      id="phone_2"
                      value="{{ old('phone_2') }}"
                      placeholder="@lang('message.phone') 2"
                      autocorrect="on">
                  ...
                  <div class="form-group{{ $errors->has('business') ? ' has-error' : ''}}">
                    <label
                    for="business"
                    class="col-xs-12 col-sm-4 col-md-4 col-lg-3 control-label">@lang('message.clients_business'): </label>
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-9">
                      <input
                      type="text"
                      class="form-control"
                      ...
                      id="business"
                      value="{{ old('business') }}"
                      placeholder="@lang('message.clients_business')"
                      autocorrect="on">
                  ...
                  <div class="form-group{{ $errors->has('email_1') ? ' has-error' : ''}}">
                    <label
                    for="email"
                    class="col-xs-12 col-sm-4 col-md-4 col-lg-3 control-label">@lang('message.email'): </label>
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-9">
                      <input
                      type="email"
                      class="form-control"
                  ...
                  <div class="form-group{{ $errors->has('reference') ? ' has-error' : ''}}">
                    <label
                    for="reference"
                    class="col-xs-12 col-sm-4 col-md-4 col-lg-3 control-label">@lang('message.clients_reference'): </label>
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-9">
                      <input
                      type="text"
                      class="form-control"
                      ...
                      id="reference"
                      value="{{ old('reference') }}"
                      placeholder="@lang('message.clients_reference')"
                      autocorrect="on">
