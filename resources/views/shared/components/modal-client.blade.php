  ...
  <div class="modal-dialog modal-lg" role="document">
    <form
      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="form-group col-xs-12{{ $errors->has('phone_1') ? ' has-error' : ''}}">
            <label
              for="phone_1"
              class="col-xs-12 col-sm-4 col-md-4 col-lg-3 control-label">
              @lang('call.phone') 1:
        ...
        <div class="row">
          <div class="form-group col-xs-12{{ $errors->has('phone_2') ? ' has-error' : ''}}">
            <label
              for="phone_2"
              class="col-xs-12 col-sm-4 col-md-4 col-lg-3 control-label">
              @lang('call.phone') 2:
        ...
        <div class="row">
          <div class="form-group col-xs-12{{ $errors->has('business') ? ' has-error' : ''}}">
            <label
              for="business"
              class="col-xs-12 col-sm-4 col-md-4 col-lg-3 control-label">
        ...
        <div class="row">
          <div class="form-group col-xs-12{{ $errors->has('email_1') ? ' has-error' : ''}}">
            <label
              for="email"
              class="col-xs-12 col-sm-4 col-md-4 col-lg-3 control-label">
              @lang('call.email'):
        ...
        <div class="row">
          <div class="form-group col-xs-12{{ $errors->has('email_2') ? ' has-error' : ''}}">
            <label
              for="email"
              class="col-xs-12 col-sm-4 col-md-4 col-lg-3 control-label">
              @lang('call.email'):
        ...
        <div class="row">
          <div class="form-group col-xs-12{{ $errors->has('reference') ? ' has-error' : ''}}">
            <label
              for="reference"
              class="col-xs-12 col-sm-4 col-md-4 col-lg-3 control-label">
